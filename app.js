...
// alert(age);
// var qualification = "Certified Web-Developer";
// alert(qualification);
...
//  var num2 = parseInt(prompt("enter num2"));
//  var add = num1 - num2 ;
//   document.write('subtraction of' + " " +  num1 + " " + 'and' + " " + num2 + " " + 'is' + " " + add);

//   var num1 = parseInt(prompt("enter num1"));
//   var num2 = parseInt(prompt("enter num2"));
//   var add = num1 * num2 ;
//    document.write('Multiplication of' + " " +  num1 + " " + 'and' + " " + num2 + " " + 'is' + " " + add);

//    var num1 = parseInt(prompt("enter num1"));
// var num2 = parseInt(prompt("enter num2"));
// var add = num1 / num2 ;
//  document.write('Division of' + " " +  num1 + " " + 'and' + " " + num2 + " " + 'is' + " " + add);

//  var num1 = parseInt(prompt("enter num1"));
// var num2 = parseInt(prompt("enter num2"));
// var add = num1 % num2 ;
//  document.write('Module of' + " " +  num1 + " " + 'and' + " " + num2 + " " + 'is' + " " + add);
...
//Write a program to implement checkout process of a shopping cart system for an e-commerce website. Storethe following in variables
